...
//  MyCarr.Onboarding
//
//  Created by Sebastian Sciuba on 24/03/2021.
//
...
class ScrollView : UIViewController {
    ...
    private let emailTextField2 = CostumRegistrationTF(placeHolder: "E-mail")
    private let nameTextField2 = CostumRegistrationTF(placeHolder: "Imię")
    private let lastnameTextField2 = CostumRegistrationTF(placeHolder: "Nazwisko")
    private let phoneTextField2 = CostumRegistrationTF(placeHolder: "Telefon")
    private let passwordTextField2 = CostumRegistrationTF(placeHolder: "Hasło")
